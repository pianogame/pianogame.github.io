(() => {
  ...
  curtain.innerHTML='<div class="hp-curtain-half"></div><div class="hp-curtain-half"></div><div class="hp-curtain-title"><span style="display:block">✦ Piano Dream Stage ✦</span><span style="display:block;margin-top:6px;font-size:.45em;letter-spacing:.08em">ピアノドリームステージ</span></div>';
